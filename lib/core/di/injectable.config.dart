...
import 'package:film_mate/application/detail/detail_bloc.dart' as _i10;
import 'package:film_mate/application/explore/explore_bloc.dart' as _i12;
import 'package:film_mate/application/home/home_bloc.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.DetailBloc>(
        () => _i10.DetailBloc(gh<_i8.DetailServices>()));
    gh.factory<_i11.HomeBloc>(() => _i11.HomeBloc(gh<_i6.HomeServices>()));
    gh.factory<_i12.ExploreBloc>(
        () => _i12.ExploreBloc(gh<_i4.ExploreServices>()));
    return this;
  }
}
